...
print ("Bem-vindo! Este programa serve para encriptar ou descriptar arquivos .txt com a Cifra de César.\n\n")

while True:
    fileName = input("Escreva o nome do arquivo com a extensão: ")
    ...
    with open(fileName, "r", encoding="utf-8") as file:
        with open( "Converted" + fileName, "w", encoding="utf-8") as newFile:
            for line in file:
                newFile.write((convert(line, transform, option))[1:])
